    ...
    $.fn.uploader = function (options, testMode) {
        return this.each(function (index) {
            options = $.extend({
                ...
                instructionsCopy: 'AGREGAR TRABAJOS DEL ARTISTA!!!',
                furtherInstructionsCopy: 'Your can also drop more files, or',
                selectButtonCopy: 'Seleccionar imágenes',
                secondarySelectButtonCopy: 'Seleccionar más imágenes',
                dropZone: $(this),
            ...
            var dom = {
                uploaderBox: $(this),
                submitButton: $('<button class="js-uploader__submit-button uploader__submit-button uploader__hide d-none">' +
                ...
                selectButton: $('<input name="secondary_img[]" style="height: 0; width: 0;" id="fileinput' + index + '" type="file" multiple class="js-uploader__file-input uploader__file-input">' +
                    '<label for="fileinput' + index + '" style="cursor: pointer;" class="btn btn-outline-dark">' +
                    options.selectButtonCopy + '</label>'),
                secondarySelectButton: $('<input name="secondary_img[]" style="height: 0; width: 0;" id="secondaryfileinput' + index + '" type="file"' +
                    ' multiple class="js-uploader__file-input uploader__file-input">' +
                    '<label for="secondaryfileinput' + index + '" style="cursor: pointer;" class="btn btn-outline-dark">' +
            ...
            function addItem (file) {
                ...
                var removeLink = $('<span class="uploader__file-list__button"><button class="uploader__icon-button js-upload-remove-button fas fa-trash-alt " data-index="' + id + '" style="cursor:pointer;"></button></span>');
